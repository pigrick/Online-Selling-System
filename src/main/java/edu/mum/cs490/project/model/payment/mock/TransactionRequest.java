...
public class TransactionRequest {
    ...
    public TransactionRequest(String txnId, String srcCardNo, String expirationDate, String nameOnCard, String CVV, String zipCode, Double amount, String dstCardNo) {
        this.txnId = txnId;

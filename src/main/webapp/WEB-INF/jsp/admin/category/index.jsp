...
<script type="text/javascript">
    ...
    module = {
        ...
        list : function(){
            $.get('/admin/category/list', $("#filterForm").serialize(), function(data){
        ...
        create : function(id){
            ...
            $.get('/admin/category/create', 'id='+id, function(data){
        ...
        changeStatus: function(id,status){
            smoke.confirm('Are sure to change status of this!',function(e){
                if (e){
                    $.get('/admin/category/changeStatus', 'id='+id+'&status='+status, function(msg){
        ...
        delete: function(id){
            smoke.confirm('Are sure to delete this!',function(e){
                if (e){
                    $.get('/admin/category/delete', 'id='+id, function(msg){
                        var message = msg.message || msg;
                        var type = 'st-'+(msg.type || 'success').toLowerCase();
                        $.sticky(message, {autoclose: 10000, position:'top-right', type: type});
                        module.list();

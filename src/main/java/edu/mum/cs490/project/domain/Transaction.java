...
public class Transaction {
    ...
    public Transaction(String sourceCardNo, String destinationCardNo, double transactionAmount, String result, String transactionId, TransactionType transactionType) {
